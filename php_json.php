...
<?php
$json = file_get_contents('https://api.smartcitizen.me/v0/devices/world_map'); /*se utiliza un archivo en linea para sacar los datos y se le asignan a la variable*/
$datos = json_decode($json,true); /*se decodifica para luego pasarlo a esta variable*/
?>
