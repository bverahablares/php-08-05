...
<p>Este Kit está instalado en: <strong><?php echo ($datos["data"]["location"]["city"])?>, <?php echo ($datos["data"]["location"]["country"])?></strong></p>
<p>La temperatura es: <strong><?php echo round($datos["data"]["sensors"][3]["value"],2)?> <?php echo ($datos["data"]["sensors"][3]["unit"])?></strong></p>
